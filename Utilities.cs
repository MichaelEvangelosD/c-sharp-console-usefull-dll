...
namespace ConsoleUtilities
{
    ...
    public class Utilities
    {
        ...
        /// <summary>
        /// Continuously ask the user to press enter,
        /// use while(!WaitForEnter()); for it to work as intended
        /// </summary>
        /// <returns>True if the user pressed enter, false is he pressed anything else</returns>
